...
async def gen_thumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            text_w, text_h = draw.textsize(f"QURAN BOT IS PLAYING OP", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"QURAN BOT IS PLAYING OP",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
                f"Quran Bot One Of The Most Advanced Telegram Quran Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"Quran Bot One Of The Most Advanced Telegram Quran Bot",
                fill="green",
                font=arial,
            )
            if para[0]:
            ...
            pass
        text_w, text_h = draw.textsize(f"Quran bot", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"Wuran Bot",
            fill="white",
        ...
        text_w, text_h = draw.textsize(f"المدة: {duration} دقيقة", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 660),
...
async def gen_qthumb(videoid, user_id, theme):
    ...
    try:
        ...
        para = textwrap.wrap(title, width=32)
        try:
            text_w, text_h = draw.textsize(f"BOT ADDED THIS PLAY TO QUEUE", font=font)
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"BOT ADDED THIS PLAY TO QUEUE",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
